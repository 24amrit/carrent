        ...
        <div className="mt-8 bg-gray-100 -mx-8 px-8 py-8">
            ...
            <div className="mt-8 mb-8 grid gap-8 grid-cols-1 md:grid-cols-[2fr_1fr]">
                <div>
                    ...
                    Pick-up:{car.pickUp} <br />
                    Drop-off:{car.dropOff} <br />
                    Max number of members: {car.maxMembers} <br />
                </div>
                <div>
            ...
            <div className="mb-4 mt-2 text-sm text-gray-700 leading-4">{car.extraInfo}</div>
            </div>
        </div>
    );
}